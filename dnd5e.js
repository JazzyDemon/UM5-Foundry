...
Hooks.once("init", function() {
  console.log(`UM5E | Initializing the rigged DnD5e Game System\n${DND5E.ASCII}`);
  ...
  Actors.registerSheet("UM5E", ActorSheet5eCharacter, {
    types: ["character"],
    makeDefault: true,
    label: "DND5E.SheetClassCharacter"
  });
  Actors.registerSheet("UM5E", ActorSheet5eNPC, {
    types: ["npc"],
    makeDefault: true,
    label: "DND5E.SheetClassNPC"
  });
  Actors.registerSheet('UM5E', ActorSheet5eVehicle, {
    types: ['vehicle'],
    makeDefault: true,
    label: "DND5E.SheetClassVehicle"
  });
  Items.unregisterSheet("core", ItemSheet);
  Items.registerSheet("UM5E", ItemSheet5e, {
    makeDefault: true,
...
Hooks.once("ready", function() {
  ...
  const currentVersion = game.settings.get("UM5E", "systemMigrationVersion");
...
Hooks.on("canvasInit", function() {
  ...
  canvas.grid.diagonalRule = game.settings.get("UM5E", "diagonalMovement");
...
Hooks.on("renderChatMessage", (app, html, data) => {
  ...
  if (game.settings.get("UM5E", "autoCollapseItemCards")) html.find(".card-content").hide();
});
